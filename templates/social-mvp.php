...
<div id="cv-social-mvp" class="cv-social-shell">
    <aside class="cv-social-sidebar" aria-label="<?php esc_attr_e('Social navigation', 'curated-vault'); ?>">
        <h2><?php esc_html_e('Community', 'curated-vault'); ?></h2>
        <button type="button" data-cv-view="feed" class="is-active"><?php esc_html_e('Feed', 'curated-vault'); ?></button>
        <button type="button" data-cv-view="notifications"><?php esc_html_e('Notifications', 'curated-vault'); ?></button>
        <button type="button" data-cv-view="messages"><?php esc_html_e('Messages', 'curated-vault'); ?></button>
    </aside>
    <main class="cv-social-main">
        <div class="cv-social-status" data-cv-status></div>
        <section data-cv-compose class="cv-social-card cv-social-compose"></section>
        <section data-cv-content></section>
    </main>
    <div data-cv-feed-messenger></div>
</div>
